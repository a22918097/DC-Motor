...
const QMetaObject MyRobot::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyRobot.data,
      qt_meta_data_MyRobot,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyRobot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyRobot.stringdata0))
        return static_cast<void*>(const_cast< MyRobot*>(this));
